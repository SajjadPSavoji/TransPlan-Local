...
def main():
    ...
    image_points, draw_frame_im = drawhelper.getpoints(maps_ss, 8)
    ...
    mid_0_3 = [int((rect[0][0]+rect[3][0])/2), int((rect[0][1]+rect[3][1])/2)]
    north_zone.append(mid_0_3)
